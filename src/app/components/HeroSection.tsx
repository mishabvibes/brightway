    ...
    <div className="relative bg-white overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 text-center lg:text-left space-y-6">
              <div className="inline-flex items-center bg-blue-50 px-4 py-2 rounded-full text-blue-600">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 text-transparent bg-clip-text">Electrical & Plumbing</span>
              </h1>
              
              <p className="text-xl text-neutral-600 max-w-xl mx-auto lg:mx-0">
            ...
            <div className="lg:w-1/2 flex justify-center">
              <div className="relative">
                ...
                {/* Floating elements */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-white rounded-xl shadow-xl p-5 animate-float">
                ...
                <div className="absolute -bottom-8 left-0 w-36 bg-white rounded-xl shadow-xl p-3 animate-float-slow">
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
          <p className="text-sm text-neutral-500 mb-2">Scroll to explore</p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              <div 
                key={index}
                className="group relative bg-white rounded-xl p-6 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl overflow-hidden"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <a href="#services" className="inline-flex items-center text-blue-600 font-medium">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-12 gap-y-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Full protection</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Trusted expertise</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Future-ready solutions</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-500">Always available</p>
              </div>
            </div>
          </div>
        </div>
