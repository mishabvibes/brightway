...
export default function EnhancedAboutSection() {
  ...
  const features = [
    ...
    {
      icon: <Award size={20} className="text-purple-600 dark:text-purple-400" />,
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-blue-500/10 dark:bg-blue-500/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-60 h-60 bg-purple-500/10 dark:bg-purple-500/5 rounded-full blur-3xl"></div>
      </div>
              ...
              {expertise.map((skill, index) => (
                <div key={index}>
                  <div className="flex justify-between items-center mb-2">
                    <span className="text-neutral-800 dark:text-neutral-200 font-medium">{skill.label}</span>
          ...
          <div className={`transition-all duration-1000 transform ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="bg-white dark:bg-neutral-900 rounded-xl p-6 shadow-lg hover:shadow-xl border border-neutral-200 dark:border-neutral-800 transition-all duration-300 hover:-translate-y-1"
                  style={{
                ...
                >
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">{feature.text}</p>
                </div>
              ))}
            </div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-video">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/20 to-indigo-500/20 dark:from-blue-900/20 dark:to-indigo-900/20 mix-blend-overlay"></div>
              
              {/* Image */}
              <div 
                className="absolute inset-0 bg-cover bg-center opacity-90 dark:opacity-70 transition-transform duration-700 hover:scale-105"
                style={{ 
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-t from-black/60 to-transparent">
                <div className="p-6 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-sm rounded-xl max-w-md">
                  <div className="flex items-center mb-4">
                    <Users size={24} className="text-blue-600 dark:text-blue-400 mr-3" />
